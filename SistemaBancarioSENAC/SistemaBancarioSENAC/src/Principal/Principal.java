...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Conta contaAna = new ContaCorrente(anaCarla, 321456, agSenac, new Date(), 3456.50, 500, 0.005);
		...
		Conta contaVini = new ContaPoupanca(vinicius, 321458, agSenac, new Date(), 34.50, 0, 0.003);
		...
		//cast
		System.out.println(((ContaCorrente) contaAna).getTaxaManutencao());
